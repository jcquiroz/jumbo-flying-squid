...
# apa.csl travels with this copy: the manuscript project supplied it via its own
# _quarto.yml, which does not apply here.
csl: apa.csl
...
This page mirrors the working paper maintained in the `manuscript-modelos`
project. Edit it there, then re-render to refresh the copy published here.
:::
