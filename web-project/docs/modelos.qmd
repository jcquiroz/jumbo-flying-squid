...
# copied from manuscript-modelos/modelos.pdf — the same file as the deposit —
# and linked below. Refresh it whenever the paper changes.
#
# That committed copy is the canonical one: `quarto render modelos.qmd --to
# typst` writes to manuscript-modelos/_manuscript/modelos.pdf, which is a
# gitignored build directory, so the render is copied up to
# manuscript-modelos/modelos.pdf and that file is what lands here.
other-links:
  - text: PDF
    href: modelos.pdf
    icon: file-pdf
